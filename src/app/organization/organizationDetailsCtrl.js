angular.module('app.organization').controller('OrganizationDetailsCtrl', ['$route', '$rootScope', '$scope', '$routeParams', '$log', 'organizationService', function($route, $rootScope, $scope, $routeParams, $log, organizationService) {
	    ...
	    organizationService.getOrganization($scope.id).then(function(response) {
		    ...
		    window.alert('organization details');
		    ...
		    // get organization quota                                                     
			    ...
			    angular.forEach(data.resources, function(organization, i) {
					...
					window.alert(organization.entity.memory_limit);
